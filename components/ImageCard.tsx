    ...
    <div className="group relative bg-white border border-gray-100 rounded-[2rem] overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500">
      ...
      <div className="p-6">
        <div className="flex items-center justify-between mb-3">
          <span className="text-[10px] font-black uppercase tracking-[0.2em] px-3 py-1.5 bg-orange-50 text-[#FF6B00] rounded-full">
            {image.type}
          </span>
          <button 
            onClick={() => downloadImage(image.url, `prakhar-ai-${image.id}.png`)}
            className="p-2.5 bg-[#FF6B00] text-white rounded-full hover:scale-110 active:scale-95 transition-all shadow-lg shadow-orange-200"
          >

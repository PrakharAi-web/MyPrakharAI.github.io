  ...
  return (
    <div className="fixed inset-0 z-[100] bg-white/90 backdrop-blur-2xl flex flex-col items-center justify-center p-6 text-center">
      <div className="relative w-24 h-24 mb-8">
        ...
        <div className="absolute inset-0 border-4 border-transparent border-t-[#EF4444] border-r-[#3B82F6] animate-spin rounded-full"></div>
      </div>
      <h2 className="text-3xl font-black text-[#1a1a1a] tracking-tighter">
        Prakhar AI is <span className="prakhar-gradient-text">Creating</span>
      </h2>
